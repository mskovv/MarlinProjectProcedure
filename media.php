            ...
            <div class="panel-container">
              ...
              <div class="panel-content">
                <div class="form-group">
                  <?php if(isset($avatar)):?>
                  <img src="uploads/<?php echo $task['avatar']?>" alt="" class="img-responsive" width="200">
                  <?php else:?>
                  <img src="img/demo/avatars/avatar-m.png" alt="no avatar" class="img-responsive" width="200">
                  <?php endif;?>
                </div>
